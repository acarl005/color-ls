...
(function() {
  ...
  sort = function(list, stats, exts) {
    ...
    i = 0;
    while (i < list.length) {
      l.push([list[i], stats[i], i, exts.length > 0 && exts[i] || i]);
      i++;
    }
    if (args.kind) {
      if (exts === []) {
